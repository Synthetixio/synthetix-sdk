...
- Add voluntaryCollateralExchange SDK wrapper — convert a non-USDT collateral to USDT to cover USDT debt, over REST and WS (#93)

### Documentation

- Note manager/delegated withdrawCollateral access control: delegated/manager signers may only withdraw to the subaccount owner's wallet, otherwise the server returns 403 (#93)
