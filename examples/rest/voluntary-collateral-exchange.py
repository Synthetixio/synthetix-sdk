"""
Voluntarily exchange a non-USDT collateral for USDT to cover USDT debt.
...
if source is None:
    ...
    result = snx.voluntary_collateral_exchange(source_asset=source, target_usdt_amount="1")
