...
| `order_type` | `str` | `"limitGtc"` | `"limitGtc"`, `"limitIoc"`, `"market"`, `"triggerTp"`, `"triggerSl"` |
...
| `await ws_get_trades(subaccount_id=None)` | Trade history |
| `await ws_get_portfolio(subaccount_id=None)` | Portfolio summary |
| `await ws_get_balance_updates(subaccount_id=None)` | Balance change history |
