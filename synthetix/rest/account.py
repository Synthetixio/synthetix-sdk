...
class AccountAPI:
    ...
    def get_open_orders(self, subaccount_id: Optional[int] = None) -> List[Dict]:
        ...
        Each order contains: order, orderId, symbol, side, type, quantity,
        price, triggerPrice, triggerPriceType, timeInForce, reduceOnly,
    ...
    def get_trades(self, subaccount_id: Optional[int] = None) -> Dict:
        ...
        """
        return self._action("getTrades", subaccount_id=subaccount_id)
    ...
    def get_balance_updates(self, subaccount_id: Optional[int] = None) -> Dict:
        ...
        """
        return self._action("getBalanceUpdates", subaccount_id=subaccount_id)
