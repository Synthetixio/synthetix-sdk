...
The repo includes standalone scripts for every endpoint under [`examples/rest/`](https://github.com/Synthetixio/synthetix-sdk/tree/main/examples/rest) and [`examples/ws/`](https://github.com/Synthetixio/synthetix-sdk/tree/main/examples/ws). Each is runnable on its own:
...
- [REST API](https://github.com/Synthetixio/synthetix-sdk/blob/main/synthetix/rest/README.md) — `MarketAPI` (public) and `AccountAPI` (authenticated)
- [WebSocket API](https://github.com/Synthetixio/synthetix-sdk/blob/main/synthetix/ws/README.md) — subscriptions, channels, and async trading methods
